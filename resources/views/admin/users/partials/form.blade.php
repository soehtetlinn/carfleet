@csrf
    <div class="mb-3">
        ...
        <input name="name" type="name" class="form-control @error('name') @enderror is-invalid" id="name" 
    ...
    <div class="mb-3">
        ...
        <input name="email" type="email" class="form-control @error('email') @enderror is-invalid" id="email" 
